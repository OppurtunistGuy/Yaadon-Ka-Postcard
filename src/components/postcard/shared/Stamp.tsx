...
export function Postmark({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center justify-center w-[92px] h-[92px] text-center select-none",
    ...
    >
      ...
      >
        <span className="text-[8px] leading-tight font-bold tracking-[0.12em] uppercase">
          {label}
        </span>
        <span className="text-[9px] leading-tight font-semibold mt-0.5 uppercase">
          {city ?? "India"}
        </span>
